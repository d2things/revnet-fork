...
export function IpfsImageUploader({
  ...
  return (
    <div className="mb-5">
      <input
        className={twMerge(
          "text-md focus:border-primary focus:shadow-te-primary dark:focus:border-primary block w-full rounded-sm border border-solid border-zinc-300 bg-clip-padding px-3 py-[0.32rem] font-normal text-zinc-700 transition duration-300 ease-in-out file:-mx-3 file:-my-[0.32rem] file:overflow-hidden file:rounded-none file:border-0 file:border-solid file:border-inherit file:bg-zinc-100 file:px-3 file:py-[0.32rem] file:text-zinc-700 file:transition file:duration-150 file:ease-in-out file:[border-inline-end-width:1px] file:me-3 hover:file:bg-zinc-200 focus:text-zinc-700 focus:outline-hidden dark:border-zinc-600 dark:text-zinc-200 dark:file:bg-zinc-700 dark:file:text-zinc-100",
