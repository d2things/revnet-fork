...
const accountAssociation = isProduction
  ? {
      header:
        "eyJmaWQiOjIxMTc5MSwidHlwZSI6ImN1c3RvZHkiLCJrZXkiOiIweDFkNDBBMTI5N0E1NjNGNmJhNzQ0ZmI5MzlBMmE2MDM1RjY5MDVGZTEifQ",
      payload: "eyJkb21haW4iOiJhcHAucmV2bmV0LmV0aC5zdWNrcyJ9",
      signature:
        "MHg2MjhlN2IxNGNlNjViYWYyODMyN2IzMDFjYzZmMjFmNDg2ZjllYzIzNWI4NDQ1MjE3Mzg4NzRjMjgzMmE2NGEzNmM3ZmRkNDI4OTFiMjkyMGIzZDMyY2FhNGY0YWJkOTAxMDhhMWNhNzg3YzNlMzhiYzg1ZGNhYzFmMzc1OGEyNzFj",
    }
  : {
      header:
      ...
      signature:
        "MHhlMTNmMTA2NmUyNDgzMjA5MGNlZTEzMjQ1OTI1MDVmNjBkZjlkMGE3NTIzM2EzNWJkM2E2MTAzZjhkMDNkMDY3MzRiMjM4OTkwZTNkMjg0NTI5NzM1MGI5MmUyMWI4Mzk1ODRlOWQ4ODZkZTU0NzI1YmY0YzgyYmJlMGFjNWE5MDFi",
    };
